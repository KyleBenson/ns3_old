 ...
 */
class MdcCollectorHelper
{
public:
  /**
   * Create MdcCollectorHelper which will make life easier for people trying
   * to set up simulations with RONs.
   *
   * \param port The port the server will wait on for incoming packets
   */
  MdcCollectorHelper (uint16_t port = 9999);
  ...
  /**
   * Create a MdcCollectorApplication on the specified Node.
   *
  ...
  /**
   * Create a MdcCollectorApplication on specified node
   *
   ...
   *
   * Create one MDC application on each of the Nodes in the
   * NodeContainer.
   *
...
/**
 * \brief create an application which sends a udp packet of sensed data to a sink,
 * possibly through a mobile data collector
 */
class MdcEventSensorHelper
{
public:
  /**
   * Create MdcEventSensorHelper which will make life easier for people trying
  ...
  /**
   * Given a pointer to a MdcEventSensor application, set the data fill of the 
   ...
   *
   * \param app Smart pointer to the application (real type must be MdcEventSensor).
   ...
   *
   * \param node The Ptr<Node> on which to create the MdcEventSensorApplication.
   *
   ...
   *
   * \param nodeName The name of the node on which to create the MdcEventSensorApplication
   *
   * \returns An ApplicationContainer that holds a Ptr<Application> to the 
   *          application created
   */
   ...
   * \param c the nodes
   *
   * Create one RON client application on each of the input nodes
   *
